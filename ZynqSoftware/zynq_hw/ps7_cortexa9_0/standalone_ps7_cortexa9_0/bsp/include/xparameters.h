...
#define XPAR_XIMGSHARPENINGFILTER_NUM_INSTANCES 1

/* Definitions for peripheral IMGSHARPENINGFILTER_0 */
#define XPAR_IMGSHARPENINGFILTER_0_COMPATIBLE "xlnx,ImgSharpeningFilter-1.0"
#define XPAR_IMGSHARPENINGFILTER_0_BASEADDR 0x40000000
#define XPAR_IMGSHARPENINGFILTER_0_HIGHADDR 0x4000ffff

/* Canonical definitions for peripheral IMGSHARPENINGFILTER_0 */
#define XPAR_XIMGSHARPENINGFILTER_0_BASEADDR 0x40000000
#define XPAR_XIMGSHARPENINGFILTER_0_HIGHADDR 0x4000ffff
#define XPAR_XIMGSHARPENINGFILTER_0_COMPATIBLE "xlnx,ImgSharpeningFilter-1.0"
...
/* Definitions for peripheral LED_GREEN */
#define XPAR_LED_GREEN_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_LED_GREEN_BASEADDR 0x41200000
#define XPAR_LED_GREEN_HIGHADDR 0x4120ffff
#define XPAR_LED_GREEN_INTERRUPT_PRESENT 0x0
#define XPAR_LED_GREEN_IS_DUAL 0x0
#define XPAR_LED_GREEN_GPIO_WIDTH 0x1

/* Canonical definitions for peripheral LED_GREEN */
...
/* Definitions for peripheral LED_RED */
#define XPAR_LED_RED_COMPATIBLE "xlnx,axi-gpio-2.0"
#define XPAR_LED_RED_BASEADDR 0x41210000
#define XPAR_LED_RED_HIGHADDR 0x4121ffff
#define XPAR_LED_RED_INTERRUPT_PRESENT 0x0
#define XPAR_LED_RED_IS_DUAL 0x0
#define XPAR_LED_RED_GPIO_WIDTH 0x1

/* Canonical definitions for peripheral LED_RED */
