...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "GaussianFilter.autotvin.dat"
	set constFileTvOut       "GaussianFilter.autotvout.dat"
	set constFileHdlTvIn     "GaussianFilter.autohdltvin.dat"
	set constFileHdlTvOut    "GaussianFilter.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
