...
//
//==============================================================
`ifndef IMGSHARPENINGFILTER_SCOREBOARD__SV                                                       
    `define IMGSHARPENINGFILTER_SCOREBOARD__SV                                                   
                                                                                               
                                                                                               
    class ImgSharpeningFilter_scoreboard extends uvm_component;                                        
                                                                                               
        ImgSharpeningFilter_reference_model refm;                                                      
                                                                                               
                                                                                               
        `uvm_component_utils_begin(ImgSharpeningFilter_scoreboard)                                     
        ...
        virtual task run_phase(uvm_phase phase);                                               
            ...
            fork                                                                               
                forever begin
                    ...
                    void'(refm.mem_blk_pages_CTRL_data_in_0.pages.pop_front());
                    void'(refm.mem_blk_pages_CTRL_data_in_1.pages.pop_front());
                    void'(refm.mem_blk_pages_CTRL_data_in_2.pages.pop_front());
                end
                forever begin
                    ...
                    refm.mem_blk_pages_CTRL_ap_return.tvout_dump_frontpage(1);
                end
