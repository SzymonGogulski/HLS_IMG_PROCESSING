...
`ifndef IMGSHARPENINGFILTER_REFERENCE_MODEL_SV
`define IMGSHARPENINGFILTER_REFERENCE_MODEL_SV

class ImgSharpeningFilter_reference_model extends uvm_component;
`define TV_IN_data_in_0 "../tv/cdatafile/c.ImgSharpeningFilter.autotvin_data_in_0.dat"
`define TV_OUT_data_in_0 ""
`define TV_IN_data_in_1 "../tv/cdatafile/c.ImgSharpeningFilter.autotvin_data_in_1.dat"
`define TV_OUT_data_in_1 ""
`define TV_IN_data_in_2 "../tv/cdatafile/c.ImgSharpeningFilter.autotvin_data_in_2.dat"
`define TV_OUT_data_in_2 ""
`define TV_IN_ap_return ""
`define TV_OUT_ap_return "../tv/rtldatafile/rtl.ImgSharpeningFilter.autotvout_ap_return.dat"
    ...
    mem_model_pages#(8,8) mem_blk_pages_CTRL_data_in_0;
    mem_model_pages#(8,8) mem_blk_pages_CTRL_data_in_1;
    mem_model_pages#(8,8) mem_blk_pages_CTRL_data_in_2;
    mem_model_pages#(8,8) mem_blk_pages_CTRL_ap_return;
    
    `uvm_component_utils_begin(ImgSharpeningFilter_reference_model)
...
misc_if.dut2tb_ap_done = 0;
        ...
        fpath.push_back(`TV_IN_data_in_0);
        mem_blk_pages_CTRL_data_in_0 = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_CTRL_data_in_0");
        mem_blk_pages_CTRL_data_in_0.tvinload_pagechk_atinit(fpath, 1*((8+7)/8), 0, 24, "");
        fpath.delete;


        fpath.push_back(`TV_IN_data_in_1);
        mem_blk_pages_CTRL_data_in_1 = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_CTRL_data_in_1");
        mem_blk_pages_CTRL_data_in_1.tvinload_pagechk_atinit(fpath, 1*((8+7)/8), 0, 32, "");
        fpath.delete;


        fpath.push_back(`TV_IN_data_in_2);
        mem_blk_pages_CTRL_data_in_2 = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_CTRL_data_in_2");
        mem_blk_pages_CTRL_data_in_2.tvinload_pagechk_atinit(fpath, 1*((8+7)/8), 0, 40, "");
        fpath.delete;


        mem_blk_pages_CTRL_ap_return = mem_model_pages#(8,8)::type_id::create("mem_blk_pages_CTRL_ap_return");
        mem_blk_pages_CTRL_ap_return.init_pages(trans_num_total, 1*((8+7)/8), 16);
        mem_blk_pages_CTRL_ap_return.tvoutdump_atinit(`TV_OUT_ap_return);
    ...
    virtual function void write_axi_rtr_CTRL(axi_pkg::axi_transfer tr);
        ...
        if(tr.addr == 0 && tr.len == 0) begin
            ...
            mem_blk_pages_CTRL_ap_return.write_elems_frontpage(tr.data, tr.byte_addr);
        end
    endfunction
endclass
`endif
