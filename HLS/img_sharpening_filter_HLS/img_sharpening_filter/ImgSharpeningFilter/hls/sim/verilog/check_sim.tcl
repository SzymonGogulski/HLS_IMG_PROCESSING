...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.ImgSharpeningFilter.autotvin_data_in_0.dat"
         "c.ImgSharpeningFilter.autotvin_data_in_1.dat"
         "c.ImgSharpeningFilter.autotvin_data_in_2.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.ImgSharpeningFilter.autotvout_ap_return.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
