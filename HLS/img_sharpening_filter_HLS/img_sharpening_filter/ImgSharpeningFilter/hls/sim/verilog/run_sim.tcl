...
if {[file isfile ImgSharpeningFilter.autotvin.dat]} {
	file delete -force ImgSharpeningFilter.autotvin.dat
}

if {[file isfile ImgSharpeningFilter.autotvout.dat]} {
	file delete -force ImgSharpeningFilter.autotvout.dat
}
